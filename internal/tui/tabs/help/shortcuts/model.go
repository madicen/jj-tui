...
func (m Model) lines() []string {
	...
	lines = append(lines, fmt.Sprintf("  %s  %s", styles.HelpKeyStyle.Width(10).Render("z"), styles.HelpDescStyle.Render("split (experimental): jj evolog parent + diff preview; moves change (and feature bookmark if present)")))
	...
	lines = append(lines, "")
	lines = append(lines, fmt.Sprintf("  %s  %s", styles.HelpKeyStyle.Width(10).Render("^j"), styles.HelpDescStyle.Render("Previous sub-tab (Shortcuts ↔ History)")))
	lines = append(lines, fmt.Sprintf("  %s  %s", styles.HelpKeyStyle.Width(10).Render("^k"), styles.HelpDescStyle.Render("Next sub-tab")))
	lines = append(lines, fmt.Sprintf("  %s  %s", styles.HelpKeyStyle.Width(10).Render("Tab"), styles.HelpDescStyle.Render("Next sub-tab")))
	lines = append(lines, "")
